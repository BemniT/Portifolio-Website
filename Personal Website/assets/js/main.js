...
const sendEmail = (e) =>{
       ...
       if(contactName.value === '' || contactEmail.value === '' || contactComment.value === ''){
        ...
        //Show message
        contactMessage.textContent = 'Write all the Required Input 🛠';
       }else{
//service_ID, template_ID, #form, Public-key
        emailjs.sendForm('service_eq3y0ln','template_8p9dysq','#contact-form','ZbMpfDAeak4m7oeAO')
        .then(() =>{
        ...
        //to clear the input  after sending the the email
        contactName.value = ''
        contactEmail.value = ''
